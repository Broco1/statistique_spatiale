...
user_name <- "user-nloaxc" # à modifier
password <- "viz75eespxc73y850a2c" # à modifier
url <- "postgresql-167938" # à modifier : conservez uniquement la partie de l'url entre les // et les :
